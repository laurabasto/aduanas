    ...
    <div class="dashboard">
      ...
      <div class="dashboard-panel dashboard-panel panel-8 ml-15 tab-formulario-usario">
        ...
        <form action="">
          ...
          <div class="form-group fm-6">
            <small class="form-text text-muted">Nombre de la compañia</small>
            <input type="text" placeholder="38.8">
          </div>
          <div class="form-group fm-6">
          ...
          <div class="form-group fm-6">
            <small class="form-text text-muted">Cargo</small>
            <input type="text" placeholder="38.8">
          </div>
          <a href="" class="ml-auto btn btn-primary"> Realizar ajustes</a>
        </form>
      </div>
